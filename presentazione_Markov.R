...
dati <- data.frame(read.table("Desktop/DataMining/HMM and HSMM/births.txt", header = TRUE))
...
dataframe_kable <- data.frame(Lambda_Bootstrap = apply(lambda_bootstrap,1,mean),
